...
#docker exec -i mysql-master -c "mysql -uroot -pL0c@lhost --host $DB_HOST --port $MASTER_PORT" < dump.db
...
#docker exec -i mysql-master -c "mysql -uroot -pL0c@lhost --host $DB_HOST --port $MASTER_PORT -e '$priv_stmt'"
